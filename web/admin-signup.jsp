...
<html>
    <head>
        ...
        <title>Hospital Management - Admin Sign Up</title>
        ...
        <style>
            body
            {
                background: url('bg-img/admin-signup-bg-img.jpg');
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card mt-5 point-card">
                            ...
                            <c:if test="${not empty successMsg}">
                                <h6 class="text-center text-success mt-2">${successMsg}</h6>
                                <%
                            ...
                            <c:if test="${not empty errorMsg}">
                                <h6 class="text-center text-danger mt-2">${errorMsg}</h6>
                                <%
                            ...
                            <div class="card-body">
                                <form action="admin_reg" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="adminName1" class="form-control" id="exampleInputPassword1" required="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Email address<span class="text-danger">*</span></label>
                                        <input type="email" name="adminEmail1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="">
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Password<span class="text-danger">*</span></label>
                                        <input type="password" name="adminPassword1" class="form-control" id="exampleInputPassword1" required="">
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" name="adminModule1" class="form-control" id="exampleInputPassword1" value="Admin" required="" style="display: none;">
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info text-white col-md-12">Sign Up</button>
                                    </div>
                                    <p class="text-center mt-2">Already Sign Up ? <a href="admin">Sign In</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
