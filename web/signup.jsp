...
<html>
    <head>
        ...
        <title>Hospital Management - User Sign Up</title>
        ...
        <style>
            body
            {
                background: url('bg-img/admin-signin-bg-img.jpg');
                            ...
                            <div class="card-body">
                                <form action="user_reg" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="userName1" class="form-control" id="exampleInputPassword1" required="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Email address<span class="text-danger">*</span></label>
                                        <input type="email" name="userEmail1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="">
                                        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Password<span class="text-danger">*</span></label>
                                        <input type="password" name="userPassword1" class="form-control" id="exampleInputPassword1" required="">
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" name="userModule1" class="form-control" id="exampleInputPassword1" value="User" required="" style="display: none;">
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-success col-md-12">Sign Up</button>
                                    </div>
                                    <p class="text-center mt-2">Already Sign Up ? <a href="user">Sign In</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
