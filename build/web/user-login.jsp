...
<html>
    <head>
        ...
        <title>Hospital Management - User Login</title>
        ...
        <style>
            body
            {
                background: url('bg-img/user-signin-bg-img.jpg');
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card mt-5 point-card">
                            <div class="card-header text-center bg-primary text-white">
                                <span class="fa fa-user fa-3x mt-2"></span>
                                <h1>User Login</h1>
                            </div>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary col-md-12 text-white">Sign In</button>
                                    </div>
                                    <p class="text-center mt-2"><a href="#">Forgot Password?</a></p>
                                    <p class="text-center">New User ? <a href="reg">Sign Up</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
